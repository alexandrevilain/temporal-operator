...
func (b *FrontendServiceBuilder) Build() client.Object {
	return &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name:        b.instance.ChildResourceName(resource.FrontendService),
			Namespace:   b.instance.Namespace,
			Labels:      metadata.GetLabels(b.instance, resource.FrontendService, b.instance.Spec.Version, b.instance.Labels),
...
func (b *FrontendServiceBuilder) Update(object client.Object) error {
	...
	service.Labels = metadata.Merge(
		object.GetLabels(),
		metadata.GetLabels(b.instance, resource.FrontendService, b.instance.Spec.Version, b.instance.Labels),
	)
